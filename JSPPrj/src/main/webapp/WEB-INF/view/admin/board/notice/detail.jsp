                    ...
                    <table class="table border-top-default">
                        <tbody>
                            <tr>
									...
									<c:if test="${!empty nextNotice}">
										<td colspan="3"  class="text-align-left text-indent"><a class="text-blue text-strong" href="/notice/detail?id=${nextNotice.id}">${nextNotice.title}</a></td>
									</c:if>
								</tr>
								<tr>
									<th>이전글</th>
									...
									<c:if test="${!empty prevNotice}">
										<td colspan="3"  class="text-align-left text-indent"><a class="text-blue text-strong" href="/notice/detail?id=${prevNotice.id}">${prevNotice.title}</a></td>
									</c:if>
								</tr>
                        </tbody>
                    </table>
