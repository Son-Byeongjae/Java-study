...
<%@page import="com.pen.web.entity.Notice"%>
					...
					<div class="notice margin-top">
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td>${n.id}</td>
									<td class="title indent text-align-left"><a href="/admin/board/notice/detail?id=${n.id}">${n.title}</a><span style="color:red;">${n.cmtCount != 0 ? [n.cmtCount] : "" }</span></td>
									<td>${n.writerId}</td>
